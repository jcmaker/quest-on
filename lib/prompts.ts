...
1. 과제는 두 문장을 넘지 않는다.
2. 첫 줄은 리서치의 목표를 설명한다.
3. 두번째 줄은 리서치를 통해 학생이 알아내야할 정보를 말해준다.
4. 학생은 따로 결과물을 제출하지 않기 때문에 ‘설명하시오.’,’제시하시오.’,’제출하시오.’ 등과 같이 결과물을 요구하는 어미를 사용하지 않고 최대한 ‘조사하시오.’,’알아보시오.’,’리서치하시오.’ 등과 같은 어미를 사용한다.
5. 학생이 감을 잡을 수 있도록 리서치할 세부적인 내용의 예를 딱 한가지만 명사형으로 제시해준다.
