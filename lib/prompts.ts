...
**채점 대상**
- 학생은 별도의 작성물을 만드는 방식이 아니라 AI와 대화하며 리서치를 수행합니다.
- 채점 입력에는 학생-AI 채팅/리서치 과정, 타임어택 퀴즈 결과, 문항별 학생 선택, 정답, 근거가 포함됩니다.
- 따라서 글의 완성도나 형식이 아니라, 채팅 과정에서 드러난 리서치 수행, 질문 흐름, 근거 검증, 이해도, 자기주도적 판단을 평가합니다.
...
9. 학생이 결론 판단을 AI에게 맡기기만 하고 검증 과정이 부족하면 **미흡**으로 평가하세요.
...
- 학생이 채팅을 통해 리서치 내용을 얼마나 잘 탐색하고 검증했는지 중심으로 작성하세요.
- AI 채팅 기록 자체가 평가 자료라는 전제를 유지하고, 그 대화형 수행 방식을 부족한 점으로 쓰지 마세요.
- 강점과 개선점은 질문 흐름, 후속 질문, 출처 검증, 자료 배제, 교차검증, AI 답변 검증, 퀴즈 이해도 신호에서만 도출하세요.
