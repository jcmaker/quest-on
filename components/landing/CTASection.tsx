            ...
            <div className="container mx-auto max-w-5xl text-center relative z-10">
                ...
                >
                    ...
                    <div className="pt-6">
                        <button
                            onClick={onCtaClick}
                            className={`group relative inline-flex items-center gap-2 px-10 py-5 rounded-full text-xl font-bold transition-all hover:scale-105 active:scale-95 ${isDark
