    ...
    return (
        ...
        >
            <div className="mx-auto max-w-7xl">
                ...
                <div className="grid grid-cols-2 gap-12 md:grid-cols-5 lg:gap-16 mb-20">
                    <div className="col-span-2 md:col-span-1 border-r pr-8" style={{ borderColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)' }}>
                        ...
                        <p className="text-sm leading-relaxed max-w-[160px] font-medium" style={{ color: colors.textSec }}>
                            AI와 함께하는 차세대 교육 평가 시스템. 사고의 과정을 데이터로 증명합니다.
                        </p>
                    </div>
                ...
                {/* Bottom Bar */}
                <div className="pt-12 border-t flex flex-col items-start justify-between gap-8 md:flex-row md:items-center" style={{ borderColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)' }}>
                    {/* Copyright & Badges */}
                    <div
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                            ...
                            <span className="text-[10px] font-bold">SOC 2 TYPE II 정식 인증</span>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                            <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
                            <span className="text-[10px] font-bold uppercase tracking-tighter">All Systems Operational</span>
                        </div>
                    </div>
                </div>
