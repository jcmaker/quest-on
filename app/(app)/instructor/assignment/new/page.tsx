...
export default function CreateAssignment() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // "2026-03-24" → 해당 날짜 23:59:59 KST → ISO
      const deadlineDate = new Date(examData.deadline + "T23:59:59+09:00");
              ...
              <div className="py-4">
                <div className="space-y-3">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1 border-t pt-3">
                    ...
                    <p>제출 기한: {examData.deadline ? `${examData.deadline} 23:59:59까지` : "-"}</p>
                  </div>
                </div>
              </div>
              <DialogFooter>
